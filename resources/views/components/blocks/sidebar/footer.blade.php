...
>
	<button
		class="hover:bg-sidebar-accent hover:text-sidebar-accent-foreground inline-flex h-8 w-full cursor-pointer items-center justify-start gap-2 rounded-md px-2 text-sm transition-colors"
		type="button"
